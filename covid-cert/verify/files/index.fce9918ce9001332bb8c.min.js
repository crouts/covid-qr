(() => {
  var t = {
          ...
          (function () {
            ...
            window.APP_HELPERS = {
              getCovidAppConfig: function () {
                var t = "https://www.gosuslugi.ru/covid-web/config.json?_=" + Math.random();
                return fetch(t, {
                  method: "GET",
                  credentials: "include",
                  cache: "no-cache",
      ...
      260: (t, e, r) => {
        ...
        for (n in R) i[n] || (L = !1);
        if (
          (!L || "function" != typeof S || S === Function.prototype) &&
          ((S = function () {
            throw TypeError("Incorrect invocation");
          }),
          L)
        )
          for (n in R) i[n] && h(i[n], S);
        if ((!L || !A || A === T) && ((A = S.prototype), L))
          for (n in R) i[n] && h(i[n].prototype, A);
        if ((L && p(w) !== A && h(w, A), o && !s(A, O)))
          for (n in ((I = !0),
          l(A, O, {
            get: function () {
      ...
      3331: (t, e, r) => {
        ...
        var n = r(7854),
          ...
          G = function (t, e, r, n, o, i) {
            var a = p(+r),
              s = m(t);
            if (a + e > s.byteLength) throw P(S);
            for (
              var u = m(s.buffer).bytes, c = a + s.byteOffset, f = n(+o), l = 0;
              l < e;
              l++
            )
              u[c + l] = f[i ? l : e - l - 1];
            ...
            return function (h, d, v, y) {
              for (
                var g,
                  ...
                  A = 0,
                  T = y || s,
                  E = e ? T(h, S) : r ? T(h, 0) : void 0;
                S > A;
                A++
              )
                if ((p || A in x) && ((m = w((g = x[A]), A, b)), t))
                  if (e) E[A] = m;
                  else if (m)
                    switch (t) {
                      case 3:
      ...
      654: (t, e, r) => {
        ...
        t.exports = function (t, e, r, f, h, w, S) {
          ...
          var A,
            ...
            C = !1,
            L = t.prototype,
            I = L[y] || L["@@iterator"] || (h && L[h]),
            R = (!v && I) || O(h),
            j = ("Array" == e && L.entries) || I;
          if (
            (j &&
              ((A = i(j.call(new t()))),
              d !== Object.prototype &&
                ...
                (l ||
                  i(A) === d ||
                  (a ? a(A, d) : "function" != typeof A[y] && u(A, y, x)),
                s(A, P, !0, !0),
                l && (p[P] = x))),
            h == m &&
              I &&
            ...
            if (((T = { values: O(m), keys: w ? R : O(g), entries: O(b) }), S))
              for (E in T) (v || C || !(E in L)) && c(L, E, T[E]);
            else n({ target: e, proto: !0, forced: v || C }, T);
          return T;
        };
      },
      7235: (t, e, r) => {
      ...
      408: (t, e, r) => {
        ...
        (t.exports = function (t, e, r, f, l) {
          ...
          for (; !(g = p.next()).done; )
            if ((y = u(p, m, g.value, f)) && y instanceof c) return y;
          return new c(!1);
        }).stop = function (t) {
          return new c(!0, t);
        };
        ...
        o("inspectSource", function (t) {
          ...
          (t.exports = function (t, e, r, o) {
            ...
            "function" == typeof r &&
              ...
              (l(r).source = p.join("string" == typeof e ? e : ""))),
              t !== n
            ...
            return (
              ("function" == typeof this && f(this).source) || u.call(this)
            );
          });
      },
      7651: (t, e, r) => {
      ...
      261: (t, e, r) => {
        ...
        (h && d) ||
          ...
          "process" == u(v)
            ...
            : ((n = A), a.addEventListener("message", S, !1))),
      ...
      9843: (t, e, r) => {
        ...
        var n = r(2109),
          ...
          Y = function (t, e) {
            return (
              D(t) && "symbol" != typeof e && e in t && String(+e) == String(e)
            );
          },
          z = function (t, e) {
        ...
        i
          ? (U ||
            ...
            n(
              ...
              { getOwnPropertyDescriptor: z, defineProperty: Z }
            ),
              ...
              U
                ...
                : ((y = r(function (t, r, n, o) {
                    ...
                    var i,
                      ...
                      l = 0;
                    if (m(r)) {
                      if (!W(r)) return D(r) ? G(y, r) : S.call(y, r);
                      (i = r), (l = d(n, e));
                      var v = r.byteLength;
                      if (void 0 === o) {
                        if (v % e) throw _(q);
                ...
                M && l(g, M, s),
                (E[s] = y),
                n({ global: !0, forced: y != v, sham: !U }, E),
                H in y || l(y, H, e),
                H in g || l(g, H, e),
                T(s);
            }))
      ...
      7321: (t, e, r) => {
        ...
        t.exports = function (t) {
          var e,
            ...
            y = i(p);
          if (null != y && !a(y))
            for (l = y.call(p), p = []; !(f = l.next()).done; ) p.push(f.value);
          for (
          ...
          { target: "Array", proto: !0, forced: !f("slice") },
          {
            slice: function (t, e) {
              ...
              if (
                ...
                return p.call(d, y, g);
              for (
                n = new (void 0 === r ? Array : r)(h(g - y, 0)), f = 0;
                y < g;
                y++, f++
              )
                y in d && c(n, f, d[y]);
        ...
        var n,
              ...
              T(function () {
                for (var o = e.value, i = 1 == e.state, a = 0; n.length > a; ) {
                  ...
                  try {
                    l
                      ? (i ||
                          (2 === e.rejection && rt(t, e), (e.rejection = 1)),
                        !0 === l
                          ? (s = o)
                          : (d && d.enter(),
                            (s = l(o)),
          ...
          Q = function (t, e, r) {
            ...
            Y
              ...
              (o = c["on" + t])
                ? o(n)
                : t === z && O("Unhandled promise rejection", r);
          },
          tt = function (t, e) {
            A.call(c, function () {
              var r,
              ...
              if (
                et(e) &&
                ((r = C(function () {
                  W ? V.emit("unhandledRejection", n, t) : Q(z, t, n);
                })),
          ...
          it = function (t, e, r, n) {
            if (!e.done) {
              (e.done = !0), n && (e = n);
              try {
                if (t === r) throw k("Promise can't be resolved itself");
                var o = J(r);
                o
                  ? T(function () {
                      var n = { done: !1 };
              ...
              [
                ...
                function (t, o) {
                  ...
                  for (var w = 0, S = 0, A = []; S < p.length; ) {
                    ...
                    if (
                      null === E ||
                      (T = d(c(b.lastIndex + (y ? 0 : S)), p.length)) === w
                    )
                      S = u(p, S, g);
                    else {
                      if ((A.push(p.slice(w, S)), A.length === x)) return A;
                      for (var O = 1; O <= E.length - 1; O++)
                        if ((A.push(E[O]), A.length === x)) return A;
                      S = w = T;
                    }
                  }
      ...
      2526: (t, e, r) => {
        ...
        var n = r(2109),
          ...
          ot = function (t, e) {
            ...
            return (
              V(r, { type: k, tag: t, description: e }),
              a || (r.description = e),
              r
            );
          },
          ...
          ut = function (t) {
            ...
            return (
              !(this === H && c(X, e) && !c(J, e)) &&
              (!(r || !c(this, e) || !c(X, e) || (c(this, M) && this[M][e])) ||
                r)
            );
          },
          ct = function (t, e) {
            ...
            if (r !== H || !c(X, n) || c(J, n)) {
              var o = W(r, n);
              return (
                !o || !c(X, n) || (c(r, M) && r[M][n]) || (o.enumerable = !0), o
              );
            }
          },
          ft = function (t) {
        ...
        s ||
          (O(
            (q = function () {
              ...
              return (
                a && rt && nt(H, e, { configurable: !0, set: r }), ot(e, t)
              );
            }).prototype,
            "toString",
            function () {
          ...
          a &&
            ...
            i || O(H, "propertyIsEnumerable", ut, { unsafe: !0 })),
          (j.f = function (t) {
            return ot(R(t), t);
          })),
          ...
          q.prototype[B] || E(q.prototype, B, q.prototype.valueOf),
          N(q, k),
          (L[M] = !0);
      },
      2990: (t, e, r) => {
      ...
      2056: (t, e, r) => {
        ...
        n.exportProto("reverse", function () {
          for (var t, e = this, r = o(e).length, n = i(r / 2), a = 0; a < n; )
            (t = e[a]), (e[a++] = e[--r]), (e[r] = t);
          return e;
        });
      },
      ...
      1637: (t, e, r) => {
        ...
        var n = r(2109),
          ...
          R = function (t) {
            return encodeURIComponent(t).replace(C, I);
          },
          j = function (t, e) {
            if (e)
            ...
            if (
              ...
              if (d(s))
                if ("function" == typeof (t = y(s)))
                  ...
                  for (a in s) l(s, a) && c.push({ key: a, value: s[a] + "" });
              else
                j(
                  c,
                  "string" == typeof s
        ...
        a(
          M,
          {
            ...
            delete: function (t) {
              ...
              for (
                var e = w(this), r = e.entries, n = t + "", o = 0;
                o < r.length;
            ...
            getAll: function (t) {
              N(arguments.length, 1);
              for (
                var e = w(this).entries, r = t + "", n = [], o = 0;
                o < e.length;
                o++
              )
            ...
            has: function (t) {
              N(arguments.length, 1);
              for (var e = w(this).entries, r = t + "", n = 0; n < e.length; )
          ...
          i(
            ...
            "toString",
            function () {
              for (var t, e = w(this).entries, r = [], n = 0; n < e.length; )
          ...
          (t.exports = { URLSearchParams: U, getState: w });
      },
    },
    e = {};
  function r(n) {
  ...
  (r.n = (t) => {
    ...
    (() => {
      ...
      function E(r, n) {
        return new Promise(function (o, a) {
          ...
          if (u.signal && u.signal.aborted)
            return a(new T("Aborted", "AbortError"));
          ...
          (c.onload = function () {
            ...
            !n || "object" !== t(n.headers) || n.headers instanceof h
      ...
      (E.polyfill = !0),
        e.fetch ||
          ((e.fetch = E), (e.Headers = h), (e.Request = x), (e.Response = S));
    })(),
    (() => {
      "use strict";
      r(6992),
        ...
        (window.APP = {
          ...
          setContainerImage: function (t) {
            ...
            switch (t.type) {
              case "TEMPORARY_CERT":
                "OK" === t.status
                  ? ((e = ""),
                    (r.certStatusName = "Действителен"),
                    (r.encertStatusName = "Valid"))
                  : "CANCELED" === t.status
                  ? ((e = "invalid"),
                    (r.certStatusName = "Аннулирован"),
                    (r.encertStatusName = "Cancelled"))
                  : "EXPIRED" === t.status
                  ? ((e = "invalid"),
                    (r.certStatusName = "Срок истёк " + t.expiredAt),
                    (r.encertStatusName = "Expired " + t.expiredAt))
                  : "404" === t.status
                  ? ((e = "invalid"),
                    (r.certStatusName = "Не найден"),
                    (r.encertStatusName = "Not found"))
                  : ((e = "invalid"),
                    (r.certStatusName = "Не действителен"),
                    (r.encertStatusName = "Invalid"));
                break;
              case "VACCINE_CERT":
                "1" === t.status
                  ? ((e = ""),
              ...
              case "COVID_TEST":
                "404" === t.status
                  ? ((e = "invalid"),
                    (r.certStatusName = "Не найден"),
                    (r.encertStatusName = "Not found"))
                  : "0" !== t.status && "3" !== t.status && "1" !== t.expired
                  ? (t.status &&
                    "отрицательный" !== t.status.toLocaleLowerCase()
                      ? ((e = "invalid"), (r.encertStatusName = "Positive"))
                      : ((e = ""), (r.encertStatusName = "Negative")),
                    (r.certStatusName = t.status))
                  : "3" === t.status || "1" === t.expired
                  ? ((e = "invalid"),
                    (r.certStatusName = "Срок истёк " + t.expiredAt),
                    (r.encertStatusName = "Expired " + t.expiredAt))
                  : ((e = "invalid"),
              ...
              case "ILLNESS_FACT":
                "1" === t.status
                  ? ((e = ""),
                    (r.certStatusName = "Переболел"),
                    (r.encertStatusName = "Recovered"))
                  : "3" === t.status && t.expiredAt
                  ? ((e = "invalid"),
                    (r.certStatusName = "Срок истёк " + t.expiredAt),
                    (r.encertStatusName = "Expired " + t.expiredAt))
                  : "404" === t.status
                  ? ((e = "invalid"),
                    (r.certStatusName = "Не найдено"),
                    (r.encertStatusName = "Not found"))
                  : ((e = "invalid"),
                    (r.certStatusName = "Не действителен"),
                    (r.encertStatusName = "Invalid"));
            ...
            if (
              ...
              var n = document.createElement("img"),
                o = document.querySelector(".qr-container");
              (o.innerHTML = ""),
                n.setAttribute(
                  "src",
                  "data:image/jpeg;charset=utf-8;base64, " + t.qr
                ),
                o.appendChild(n),
              ...
              a.classList.remove("hide"),
                (a.innerHTML =
                  "ru" === r.lang ? "Версия для печати" : "Print version"),
                a.setAttribute("href", t.pdfUrl);
            }
            return e;
          },
          ...
          completeDates: function (t, e) {
            for (
              var r = [],
                n = t.some(function (t) {
                  return "Дата результата" === t.title;
                }),
                o = t.some(function (t) {
              ...
              var u = t[s];
              ("Дата результата" === u.title && n) ||
                ("Действует до" === u.title && (i || a)) ||
                r.push(t[s]);
            }
            return (
              o ||
          ...
          showAttrs: function (t) {
            ...
            if (t && t.length)
              for (var n = 0; n < t.length; n++) {
                var o = "mb-4 person-data-wrap attr-wrap",
                  i = "small-text mb-4 mr-4 attr-title",
                  a = "attrValue";
                "enPassport" === t[n].type &&
                  "ru" === r.lang &&
                  (o = "mb-4 person-data-wrap attr-wrap hide"),
                  "fio" === t[n].type
                    ? ((i = "small-text mb-4 mr-4 attr-title hide"),
                      (a = "attrValue title-h6 bold text-center"))
                    : (a = "attrValue small-text gray"),
                  (e.innerHTML += '<div class="'
                    .concat(o, '"><div class="')
                    .concat(i, '">')
                    .concat(r.getValue(t[n], "title"), ': </div><div class="')
                    .concat(a, '">')
                    .concat(r.getValue(t[n], "value"), "</div></div>"));
              }
          ...
          fadeOutEffect: function (t) {
            var e = setInterval(function () {
              t && !t.style.opacity && (t.style.opacity = "1"),
                t && parseFloat(t.style.opacity) > 0
                  ? (t.style.opacity = parseFloat(t.style.opacity) - 0.5 + "")
                  : t && (clearInterval(e), t.parentNode.removeChild(t));
            }, 10);
          },
          init: function () {
            ...
            var t = this,
              e = window.location.pathname
                ...
                .pop(),
              r = window.location.pathname.includes("/status/"),
              n = t.config.covidCertUrl + "cert/status/",
              o = (r ? n : t.config.covidCertCheckUrl) + e,
              i = this.getParam("lang");
            this.lang = i || "ru";
            var a = this.getParam("ck");
            if (
              ((this.isShowQRCode = "true" === this.getParam("qr")), i || a)
            ) {
              var s = i ? "lang=".concat(i) : "";
              s && a ? (s += "&ck=".concat(a)) : a && (s += "ck=".concat(a)),
                (o += "?".concat(s));
            }
            ...
            function c(e) {
              ...
              (t.cert = r),
                ...
                t.fadeOutEffect(document.getElementById("start-app-loader"));
              var n = document.querySelector(".unrz"),
                o = document.querySelector(".num-symbol");
              if (r.attrs) {
                ...
                t.showDates(i),
                  t.showAttrs(
                    t.filterAttrs(
                      r,
                      ["passport", "enPassport", "birthDate", "fio"],
                      "en" === t.lang
                    )
                  );
              }
              var a = t.setContainerImage(r);
              a && document.querySelector(".status-container").classList.add(a),
                r.unrzFull
                  ? (n.innerHTML = r.unrzFull.replace(
                      /^(.{4})(.{4})(.{4})(.*)$/,
                      "$1 $2 $3 $4"
                    ))
                  : (n.classList.add("hide"), o.classList.add("hide")),
                t.setAdditionalInfo(r),
                t.setText(r);
            }
            t.cert
              ? c(t.cert)
          ...
          setText: function (t) {
            ...
            if (
              ((document.querySelector(".main-title").innerHTML = this.getValue(
                t,
                "title"
              )),
              (document.querySelector(".button").innerHTML =
                "ru" === this.lang ? "Закрыть" : "Close"),
              (document.querySelector(".lang").innerHTML =
                "ru" === this.lang ? "RUS" : "ENG"),
              e.classList.remove("ru", "en"),
              e.classList.toggle(this.lang),
              t.unrzFull &&
                t.unrzFull.startsWith("4") &&
              ...
              r.classList.remove("hide"),
                (r.innerHTML = this.getValue(t, "invalid"));
            } else {
              var n = document.querySelector(".cert-name");
              n.classList.remove("hide"),
                (n.innerHTML = this.getValue("", "certStatusName"));
            }
          },
          setAdditionalInfo: function (t) {
            var e = document.querySelector(".additional-info");
            if ("1" !== t.expired || "COVID_TEST" !== t.type) e && e.remove();
            else {
